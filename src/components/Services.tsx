        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map((service, index) => (
              <Card 
                key={index} 
                className="group hover:shadow-elegant transition-smooth border-0 bg-background/80 backdrop-blur-sm hover:-translate-y-2"
              >
          ...
          <div className="text-center bg-gradient-primary rounded-2xl p-8 md:p-12 shadow-elegant">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                className="bg-secondary hover:bg-secondary-glow text-secondary-foreground shadow-secondary transition-bounce px-8 py-4"
              >
                Solicitar Orçamento
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="border-white/60 text-white hover:bg-white/10 hover:border-white transition-smooth px-8 py-4"
                onClick={() => window.open('https://wa.me/5531972398971', '_blank')}
              >
                Falar no WhatsApp
              </Button>
            </div>
